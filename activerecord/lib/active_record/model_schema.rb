  ...
  module ModelSchema
    ...
    module ClassMethods
      ...
      def full_table_name_prefix #:nodoc:
        (parent_modules.detect{ |p| p.respond_to?(:table_name_prefix) } || self).table_name_prefix
      end

      def full_table_name_suffix #:nodoc:
        (parent_modules.detect {|p| p.respond_to?(:table_name_suffix) } || self).table_name_suffix
      end
